...
function SelectedStarlinkInfo(props) {
      ...
      {isLoading
        ...
        : (
          <div id='selected-satellite-info'>
            <div id='selected-satellite-name' className='selected-satellite-details'>
              <b>
                {selectedStarlink.spaceTrack === undefined ? null : selectedStarlink.spaceTrack.OBJECT_NAME}
              </b>
            </div>
...
export default SelectedStarlinkInfo;
